/**
 * Generated from /Users/frank/Downloads/wechat-smart-layout-tool/styles.ts
 * Source-of-truth preset library for editorial WeChat themes.
 */
...
export const RAW_THEME_PRESETS = {
  ...
  "wechat-anthropic": {
    ...
    "styles": {
      ...
      "h1": "font-size: 48px; font-weight: 600; color: #C15F3C !important; line-height: 1.15 !important; margin: 64px 0 32px; letter-spacing: -0.025em;",
      "h2": "font-size: 36px; font-weight: 600; color: #C15F3C !important; line-height: 1.25 !important; margin: 56px 0 28px; letter-spacing: -0.02em;",
      ...
      "pre": "margin: 40px 0; padding: 28px; background-color: #2b2b2b !important; color: #f5f5f5 !important; border-radius: 12px; overflow-x: auto; line-height: 1.6 !important;",
      "hr": "margin: 64px auto; border: none; height: 2px; background-color: rgba(193, 95, 60, 0.3) !important; max-width: 240px;",
      ...
      "th": "background-color: rgba(193, 95, 60, 0.08) !important; padding: 16px 20px; text-align: left; border: none; font-weight: 600; color: #2b2b2b !important; border-bottom: 2px solid rgba(193, 95, 60, 0.2);",
  ...
  "wechat-jonyive": {
    "name": "Jony Ive",
    "styles": {
      "container": "max-width: 620px; margin: 0 auto; padding: 40px 24px; font-family: -apple-system, BlinkMacSystemFont, \"SF Pro Display\", \"SF Pro Text\", \"Helvetica Neue\", Arial, sans-serif; font-size: 17px; line-height: 1.6 !important; color: #6e6e73 !important; background-color: #fbfbfd !important; word-wrap: break-word;",
      ...
      "blockquote": "margin: 40px auto; padding: 0; background-color: transparent !important; border-left: none; color: #1d1d1f !important; font-size: 20px; line-height: 1.4 !important; font-weight: 300; text-align: center; max-width: 520px; font-style: normal;",
  ...
  "ando-concrete": {
    ...
    "styles": {
      ...
      "pre": "margin: 60px 0; padding: 40px; background-color: #2a2a2a !important; color: #f0f0f0 !important; border: none; overflow-x: auto; line-height: 1.8 !important;",
  ...
  "gaudi-organic": {
    ...
    "styles": {
      ...
      "h1": "font-size: 52px; font-weight: 700; color: #ff6b6b !important; line-height: 1.2 !important; margin: 70px 0 35px; text-align: center; letter-spacing: -0.02em; position: relative; padding: 20px;",
      ...
      "li": "margin: 20px 0; line-height: 1.8 !important; color: #3d2914 !important; padding: 15px 25px 15px 45px; background: linear-gradient(90deg, rgba(255, 193, 7, 0.1) 0%, transparent 30%); border-radius: 30px 60px 120px 30px / 120px 30px 60px 30px;",
      "blockquote": "margin: 50px auto; padding: 35px 40px; background: radial-gradient(circle at top left, rgba(255, 107, 107, 0.1) 0%, rgba(109, 207, 127, 0.1) 25%, rgba(78, 205, 196, 0.1) 50%, rgba(91, 134, 229, 0.1) 75%, rgba(165, 94, 234, 0.1) 100%); border: 3px solid #ff6b6b !important; border-radius: 50% 20% / 10% 40%; color: #3d2914 !important; font-size: 20px; line-height: 1.8 !important; font-style: italic; text-align: center; max-width: 600px;",
      ...
      "pre": "margin: 45px 0; padding: 35px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff !important; border-radius: 30px; overflow-x: auto; line-height: 1.6 !important;",
      "hr": "margin: 70px auto; border: none; height: 30px; background-color: transparent !important; max-width: 300px; border-bottom: 2px wavy #c0392b;",
      "img": "max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 50px auto; border-radius: 12px; border: 2px solid #ffd93d;",
      "table": "width: 100%; margin: 45px 0; border-collapse: separate; border-spacing: 5px; font-size: 16px;",
      "th": "background: linear-gradient(45deg, #ff6b6b 0%, #ffd93d 100%); color: #fff !important; padding: 18px; text-align: left; font-weight: 600; border-radius: 15px 15px 0 0;",
  ...
  "guardian": {
    ...
    "styles": {
      ...
      "h2": "font-size: 32px; font-weight: 600; color: #052962 !important; line-height: 1.25 !important; margin: 35px 0 18px; padding: 12px 16px; border-left: 5px solid #C70000; background-color: #f6f6f6 !important;",
  ...
  "lemonde": {
    ...
    "styles": {
      ...
      "hr": "margin: 60px auto; border: none; height: 1px; background-color: #2c2c2c !important; max-width: 100px;",
      "img": "max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 40px auto; border-radius: 8px; filter: sepia(10%);",
