...
- Relevant corpus or reference material exists → **+1** + flag "有参考材料支撑"
...
| Recommended framework | One of the available frameworks in `frameworks.md` + one-line reasoning |
...
Industry data, personal experience, insider access, curated reference materials. This produces the highest-performing articles but requires genuine information advantage. If you don't have one, the article will be shallow no matter how well-written.
